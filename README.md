...
Скрипт обновит код, установит зависимости, пересоберёт фронтенд и статику Django, применит миграции, перезапустит сервис `star-burger` и отправит уведомление о деплое в Rollbar.
